...
$getvehiculo = $vehiculo->listarvehiculo();

//var_dump($getvehiculo);
...
<body>
  <div class="container">
      ...
      <div id="menu">
        ...
        <tr>              
          ...
          <td style="background-color: white;widtd: auto"> <select name="datobuscar" id="datobuscar" style="widtd: 180px; border-color: black" class="btn btn-block busqueda">
            ...
            <option value="a.COT_CODIGO">Matricula</option>
            <option value="a.COT_RUT">Modelo</option>
            <option value="a.COT_EMPRESA">Marca</option>
            <option value="a.COT_FECHA">Año</option> 
            </select> 
          </td>       
          ...
          <td style="background-color: white;padding:1 0 0 5;">
            ...
            <input type="button" name="volver" id="volver" class="form-submit"
             onclick="window.location.href='creveh.php'" value="Agregar Vehiculo" style=" margin-top: 3; margin-bottom: 3;widtd:98%; padding-top: 10px; padding-bottom: 10px;"/>
           </td> 
        </tr>             
      </table>
    </center>
   ...
   <div name="tabla-contenido" id="tabla-contenido">
          ...
          <?php 
            foreach($getvehiculo AS $key => $value){
              echo "<tr>";
              echo "<td>".($key+1)."</td>".
                  "<td>".$getvehiculo[$key]['id']."</td>".
                  "<td>".$getvehiculo[$key]['matricula']."</td>".
                  "<td>".$getvehiculo[$key]['modelo']."</td>".
                  "<td>".$getvehiculo[$key]['marca']."</td>".
                  "<td>".$getvehiculo[$key]['anio']."</td>".
                  "<td>".
                  "<a href='getveh.php?veh_id=".$getvehiculo[$key]['id']."'  ".
                  "class='btn' style='margin: 0 3 0 0'><img src='../../assets/img/view.png' widtd= 15px' ". 
                  "height= 15px'></a>".
                  "<a href='modveh.php?veh_id=".$getvehiculo[$key]['id']."'  ".
                  "class='btn' style='margin: 0 3 0 0'><img src='../../assets/img/edit.png' ' widtd= 15px' ".
                  "height= 15px'></a>".
                  "<a href='impveh.php?veh_id=".$getvehiculo[$key]['id']."'  ". 
                  "class='btn' style='margin: 0 3 0 0'><img src='../../assets/img/imp.png' widtd= 15px' ".
                  "height= 15px'></a>".
                  "<a href='elimveh.php?veh_id=".$getvehiculo[$key]['id']."'  ". 
