...
<img style="height: 100px;margin: 0px 0px 0px auto;" src="../../assets/img/taxi.png"><br>
        <center>
          <h1>Eliminar Vehiculo - Radio Taxi Seven N° <?php echo $id ?></h1>
        </center>
      ...
      <div id="uno">
        <table style="width:100%">
            ...
            <td style="text-align: right;">Usuario:</td>
              ...
              <td style="background-color: white;"><input type="date" id="fecha" name="fecha" value="<?php echo $getdatavehiculo[0]['fecha']?>" required></td>
            </tr>
            <tr>  
      ...
      <div class="botones">
      <center>    
      <button id="acot" type="submit" class="form-submit">Eliminar Vehiculo</button>   
